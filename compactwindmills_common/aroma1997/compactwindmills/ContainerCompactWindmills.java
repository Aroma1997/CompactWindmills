...
public class ContainerCompactWindmills extends Container {
	...
	public ContainerCompactWindmills(IInventory inventory, TileEntityWindmill tileEntityCW, WindType windType) {
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (par2 != 1 && par2 != 0)
            {
                ...
                else if (par2 >= 28 && par2 < 37 && !this.mergeItemStack(itemstack1, 1, 27, false))
                {
                    return null;
                }
            }
