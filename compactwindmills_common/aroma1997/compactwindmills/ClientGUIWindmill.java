...
public class ClientGUIWindmill extends GuiContainer {
	...
	public enum GUI {
		...
		protected Container makeContainer(IInventory playerInventory,
	...
	private ClientGUIWindmill(GUI type, IInventory inventory,
			TileEntityWindmill tileEntityCW) {
		super(type.makeContainer(inventory, tileEntityCW));
		this.type = type;
		allowUserInput = false;
		container = (ContainerCompactWindmills) type.makeContainer(inventory,
				tileEntityCW);
	}
