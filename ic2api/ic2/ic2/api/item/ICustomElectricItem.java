 ...
 * tier, transfer limit and simulate into account - replace item IDs if
 * appropriate (getChargedItemId() and getEmptyItemId()) - update and manage the
 * damage value for the visual charge indicator
 * 
